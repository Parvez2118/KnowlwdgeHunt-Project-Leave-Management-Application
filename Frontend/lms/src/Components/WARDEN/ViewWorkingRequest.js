...
const color=(a)=>{
 ...
 AddStudent
   ...
   <h1 style={{color:"#0E2431",fontFamily: 'Cabin'}} >Workingday Leaves</h1> 
  </div>
  </center>
  ...
  <thead style={{backgroundColor:" rgb(222, 238, 252)"}}>
    <tr>
      ...
      <th scope="col" style={{color:"#0E2431",fontSize:17+"px",fontFamily: 'Cabin'}} > Wardens Status</th>
      <th scope="col" style={{color:"#0E2431",fontSize:17+"px",fontFamily: 'Cabin'}} > Update Status</th>
      <th scope="col" style={{color:"#0E2431",fontSize:17+"px",fontFamily: 'Cabin'}} > Hod's Status</th>
...
export default ViewWorkingRequest;